        ...
        <div className="mx-3">
            ...
            <div className="row">
                <div className="col-md-4 bg-light p-4 rounded">
                    <p className="mb-3">
                        {movie && movie.Year} {'\u00B7'} {movie && movie.Rated} {'\u00B7'} {movie && movie.Runtime}
                    </p>
                    <img src={movie && movie.Poster} alt="The Movie Poster" className="img-fluid mb-3" />
                    <p className="mb-1">
                    ...
                    <ProtectedContent>
                        {!alreadyLiked() ? (
                            <button onClick={handleRefreshLike} disabled={clicked} className="btn btn-success ms-2">
                                Like
                            </button>
                        ) : (
                            <button onClick={handleRefreshUnlike} disabled={clicked} className="btn btn-danger ms-2">
                                Unlike
                            </button>
                        )}
                    </ProtectedContent>
